...
public class DBManager {
    ...
    public synchronized boolean saveUser(User user){
        ...
        values.put(UserDao.USER_COLUMN_AVATAR_LASTUPDAT_TIME,user.getMavatarLastUpdateTime());
        if (db.isOpen()){
    ...
    public User getUser(String username){
        ...
        if (cursor.moveToNext()){
            ...
            user.setMavatarLastUpdateTime(cursor.getString(cursor.getColumnIndex(UserDao.USER_COLUMN_AVATAR_LASTUPDAT_TIME)));
            return user;
        }
        return user;
    }
